...
import settings
from various.utils import calculate_mean_squared_error, r_from_s
...
def histo_inference(indices_X=None,
                    ...
                    options=''):
    """
    Approximates the likelihood throungh Approximate Frequentist Inference,
    ...
    Input:
        denominator:
        use_smearing:
        indices_X: Defines which of the features to histogram.
        binning:
        use_smearing:
        do_neyman:
    ...
    for t, theta in enumerate(settings.thetas):
        ...
        histogram.fit(summary_statistics_train, y_train)
