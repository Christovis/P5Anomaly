...
import settings
from various.utils import s_from_r, r_from_s


def truth_inference(do_neyman=False, denominator=0, options=''):
    """ 
    ...
    logging.debug('NC settings: %s %s %s %s %s', neyman2_mode,
                  neyman_filename, n_expected_events_neyman,
                  n_neyman_null_experiments, n_neyman_alternate_experiments)
    logging.debug('Diagnostics settings: %s %s',
                  input_filename_addition, filename_addition)
